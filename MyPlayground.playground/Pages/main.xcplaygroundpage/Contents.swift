...
func isForceWith(name: String) -> Bool {
    ...
    let forceNamesArray : [String] = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]
    
    for forceName in forceNamesArray {
        
        if name.lowercaseString == forceName.lowercaseString {
...
*/
func transferFunds(myAccount: Double, otherAccount: Double) {
